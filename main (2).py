...
# Bot credentials
API_ID = int(os.getenv('API_ID', '29707638'))
API_HASH = os.getenv('API_HASH', 'b818547381348f3b05842d7ae34eb1a6')
BOT_TOKEN = os.getenv('BOT_TOKEN', '7778515412:AAEQT4emxwDm4JLeWSpwaABEe7gF8LWUGYY')
